# Generated by Django 4.1.1 on 2023-10-20 05:41
...
class Migration(migrations.Migration):
    dependencies = [
        ("season_05", "0002_alter_domain_stat"),
    ]
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        ...
                        "Extraction: SuccessfulExtractions",
                    ),
                    (
                        "ExtractionStats_ExtractionConversionsDenied",
                        "Extraction: ExtractionConversionsDenied",
                    ),
                    (
                        "ExtractionStats_ExtractionConversionsCompleted",
                        "Extraction: ExtractionConversionsCompleted",
                    ),
                    (
                        "ExtractionStats_ExtractionInitiationsDenied",
                        "Extraction: ExtractionInitiationsDenied",
                    ),
                    (
                        "ExtractionStats_ExtractionInitiationsComplete",
                        "Extraction: ExtractionInitiationsComplete",
                    ),
