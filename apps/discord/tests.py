...
class DiscordAccountTestCase(TestCase):
    ...
    def test_discord_account_save(self):
        ...
        self.assertEqual(account.discord_username, "ABC1234")
    ...
    def test_update_or_create_discord_account(self):
        # New ID & username should result in account creation
        update_or_create_discord_account("123", "ABC1234", self.user)
        ...
        self.assertEqual(discord_account_1.discord_username, "ABC1234")
        ...
        # Same ID with new username should result in account update
        update_or_create_discord_account("123", "DEF1234", self.user)
        ...
        self.assertEqual(discord_account_2.discord_username, "DEF1234")
        ...
        # New ID but same username should result in second account creation
        update_or_create_discord_account("456", "DEF1234", self.user)
        ...
        self.assertEqual(discord_account_3.discord_username, "DEF1234")
